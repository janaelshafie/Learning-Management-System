...
@Entity
@Table(name = "CourseMaterialAttributes")
public class CourseMaterialAttributes {
    @Id
    ...
    // Constructors
    public CourseMaterialAttributes() {}

    public CourseMaterialAttributes(String attributeName, String valueType) {
